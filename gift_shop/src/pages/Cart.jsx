...
const Cart = () => {
  ...
  const { cartItems, emptyCart } = useContext(GlobalInfo);
  const total = cartItems.reduce((acc, val) => acc + val.price, 0);
      ...
      <Wrapper>
        ...
        <Bottom>
                  ...
                  <div key={ind}>
                    <Product>
                      ...
                      <PriceDetail>
                        ...
                        <ProductPrice>RS: {data.price}</ProductPrice>
                      </PriceDetail>
                    </Product>
                    <Hr />
                  </div>
          ...
          <Summary>
            ...
            <Button onClick={checkoutHandle}>CHECKOUT NOW</Button>
          </Summary>
        </Bottom>
      </Wrapper>
      <Footer />
